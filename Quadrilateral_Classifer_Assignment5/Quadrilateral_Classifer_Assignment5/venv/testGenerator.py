...
def parallelogram_answer_key():
    file = open(path + "paralellogramExpected.txt", "w")
...
def generate_rand_shape_to_500():
    num = 501
    for i in range(500):
        file = open(path + str(num) + ".txt", "w")
        file.write(str(random.randint(-100, 100)) + " " + str(random.randint(-100, 100)) + " " + str(random.randint(-100, 100))
                   + " " + str(random.randint(-100, 100)) + " " + str(random.randint(-100, 100)) + "\n")
        num += 1
    file.close()
